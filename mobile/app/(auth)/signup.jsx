...
const signup = () => {
  ...
  const [showPassword, setShowPassword] = useState(false);
  const [isPendingVerification, setIsPendingVerification] = useState(false); // Toggle view
        ...
        <View style={styles.card}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>
              {isPendingVerification ? "Verify your email" : "Share your favorite read"}
            </Text>
          </View>
            ...
            {!isPendingVerification ? (
              ...
              <>
                ...
                <TouchableOpacity style={styles.button} onPress={handleVerifyOTP} disabled={isLoading}>
                  {isLoading ? <ActivityIndicator color={COLORS.white} /> : <Text style={styles.buttonText}>Verify & Login</Text>}
                </TouchableOpacity>

                <TouchableOpacity 
                  onPress={() => resendOTP(email).then(() => Alert.alert("Sent!", "Check your inbox again."))}
